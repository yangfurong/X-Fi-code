...
#ifdef __cplusplus
#define HASHMAP_BASE(h)  (reinterpret_cast<HashmapBase*>(h))
#define PLAIN_HASHMAP(h) (reinterpret_cast<Hashmap*>(h))
#else
...
static inline Hashmap *hashmap_free(Hashmap *h) {
        return (Hashmap*)internal_hashmap_free(HASHMAP_BASE(h));
}
static inline OrderedHashmap *ordered_hashmap_free(OrderedHashmap *h) {
        return (OrderedHashmap*)internal_hashmap_free(HASHMAP_BASE(h));
}

HashmapBase *internal_hashmap_free_free(HashmapBase *h);
static inline Hashmap *hashmap_free_free(Hashmap *h) {
        return (Hashmap*)internal_hashmap_free_free(HASHMAP_BASE(h));
}
static inline OrderedHashmap *ordered_hashmap_free_free(OrderedHashmap *h) {
        return (OrderedHashmap*)internal_hashmap_free_free(HASHMAP_BASE(h));
}

Hashmap *hashmap_free_free_free(Hashmap *h);
static inline OrderedHashmap *ordered_hashmap_free_free_free(OrderedHashmap *h) {
        return (OrderedHashmap*)hashmap_free_free_free(PLAIN_HASHMAP(h));
}
